class REPR_TYPE:
    ...
    CBR = "CBR"
    SCHEMAFILTER_REPRESENTATION = "SCHEMAFILTER"
    SCHEMAFILTER_SQL = "SCHEMAFILTERSQL"
    CHESS_SQL = "CHESS"
    CHESS_NO_COT = "CHESSNOCOT"
    CHESS_NO_INSTRUCTION = "CHESSNOINSTRUCTION"
    CHESS_NO_INSTRUCTION_PRED_SCHEMA = "CHESSNOINSTRUCTIONPREDSCHEMA"
    CHESS_NO_INSTRUCTION_PRED_SCHEMA_OPT = "CHESSNOINSTRUCTIONPREDSCHEMAOPT"
