...
from .linking_utils import abstract_preproc, corenlp, serialization
from .linking_utils.spider_match_utils import (
...
class SpiderEncoderV2Preproc(abstract_preproc.AbstractPreproc):
    ...
    def preprocess_item(self, item, schema, validation_info):
        ...
        example_str = item['example'] if 'example' in item.keys() else ""
        return {
